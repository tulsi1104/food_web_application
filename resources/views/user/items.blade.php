...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="product">
            <img src="{{ asset($products->image_url)}}" alt="Product Image">
            ...
            @csrf
                ...
                <button type="submit" name="action" value="addToCart" style="background-color: #4CAF50; /* Green */
                                    border: none;
                                    color: white;
                                    padding: 9px 32px;
                                    text-align: center;
...
<script>
    ...
    function addToCart(productId) {
        if (button.getAttribute("data-added") === "false") {
            // Implement logic to add the product to the cart
            console.log('Adding product with ID ' + button.getAttribute("data-product-id") + ' to cart...');
