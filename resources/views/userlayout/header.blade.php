    ...
    <div class="position-relative">
        ...
        <div class="container-fluid navbar-inner">
            <a href="../dashboard/index.html" class="navbar-brand">
                <!--Logo start-->
                <div class="logo">
                    <svg width="40" height="43"  class="text-primary" viewBox="0 0 60 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    <li>
                        <form action="{{ route('logout.logout') }}" method="POST">
                            @csrf
                        <button type="submit" class="dropdown-item nav-link text-black">Logout</button>
                        </form>
                    </li>
                </ul>
                </li>
